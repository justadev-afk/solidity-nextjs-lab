...
import { ArrowLeft, BookOpen, Coffee, FileCode } from "lucide-react";

import { Badge } from "@/components/ui/badge";
import { Separator } from "@/components/ui/separator";
import { exercises } from "@/lib/exercises";

import { CoffeeTipJarApp } from "./_components/coffee-tip-jar-app";

const SLUG = "01-coffee-tip-jar";

const exercise = exercises.find((item) => item.slug === SLUG);

const exerciseNumber = exercise?.number ?? "01";
const title = exercise?.title ?? "Coffee Tip Jar";
const summary =
  exercise?.summary ??
  "A tip jar that takes ETH with a name and a message, and lets only the owner withdraw.";
...
export default function CoffeeTipJarPage() {
  return (
